...
public class PackedSnowballEntity extends ThrownItemEntity {
	...
	protected Item getDefaultItem() {
		return GrishaItems.PackedSnowballItem;
	}
	...
	protected void onCollision(HitResult hitResult) { // called on collision with a block
		...
		if (!this.world.isClient) { // checks if the world is client
			...
			this.remove(RemovalReason.DISCARDED); // kills the projectile
		}
    ...
    public Packet createSpawnPacket() {
    	return EntitySpawnPacket.create(this, ProjectileTutorialMod.PacketID);
    }	
}
