...
public class GrishaThrownAttackGoal <T extends HostileEntity & RangedAttackMob> extends Goal{
	   ...
	   public GrishaThrownAttackGoal(T actor, double speed, int attackInterval, float range) {
	      this.actor = actor;
	      this.speed = speed;
	   ...
	   public void tick() {
	      ...
	      if (livingEntity != null) {
	         ...
	         /*if (this.actor.isUsingItem()) {
	        	 System.out.println("isUsingItem");
	            if (!bl && this.targetSeeingTicker < -60) {
	               ...
	               if (i >= 20) {
	                  ...
	                  ((RangedAttackMob)this.actor).attack(livingEntity, 1F);
